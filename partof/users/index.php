...
if (isset($_POST['submit'])) {
    ...
    $ret = mysqli_query($bd, $query);

    if (!$ret) {
        die("Database query failed: " . mysqli_error($bd));
    }
    ...
    if ($num) {
        ...
        // mysqli_query($bd, "INSERT INTO userlog(uid, username, userip, status) 
        //     VALUES('{$_SESSION['id']}', '$username', '$uip', '$status')");
      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <!-- <div id="login-page"> -->
	  	<!-- <div class="container"> -->
		      ...
		      <form class="form-login" name="login" method="post" style="margin-top: 15px">
