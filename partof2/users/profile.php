...
<html lang="en">
  <head>
    ...
    <title>KsTU H.D User Change Password</title>
     ...
     <?php include("includes/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> User Personal Info</h3>
 ...
 ?>                     
  ...
  <h4 class="mb"><i class="fa fa-user"></i>&nbsp;&nbsp;<?php echo htmlentities($row['fullName']);?>'s Info</h4>
...
<label class="col-sm-2 col-sm-2 control-label">Name of faculty</label>
<div class="col-sm-4">
...
<label class="col-sm-2 col-sm-2 control-label">Name of Department </label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Index Number</label>
<div class="col-sm-4">
