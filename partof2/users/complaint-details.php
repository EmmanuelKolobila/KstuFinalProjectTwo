...
<label class="col-sm-2 col-sm-2 control-label"><b>Being here before :</b> </label>
              <div class="col-sm-4">
  ...
  <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Problem was Answered?:</b></label>
              <div class="col-sm-4">
...
<label class="col-sm-2 col-sm-2 control-label"><b>State :</b></label>
  ...
  <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Nature of Problem :</b></label>
              <div class="col-sm-4">
