...
if(isset($_GET['del']))
		  {
                  ...
                  $_SESSION['delmsg']="Option deleted !!";
		  }
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Checking If The Privious Solution Answered The student Problem</h3>
							</div>
...
<label class="control-label" for="basicinput">Set Option</label>
<div class="controls">
<input type="text" placeholder="Enter Option"  name="state" class="span8 tip" required>
</div>
</div>
