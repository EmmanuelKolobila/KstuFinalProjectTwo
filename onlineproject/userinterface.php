...
<body style="baground-color: #111;">
 ...
 <!--  <div id="head">
    <div id="headbox">
      ...
      <a href="index.php" style="color: unset;"><div id="comment">HOME</div></a>
      
    </div>
  </div> -->
  <div class="menu-wrap" style="z-index: 00px!important; margin-top: 80px;">
    <input type="checkbox" class="toggler">
    <div class="hamburger">
      <div></div>
      <!-- <div style="color: red;">CLIK ME</div> -->
    </div>
    <div id="menuhide" class="menu">
      <div>
        <div>
          <ul>
            <li><a href="pothome.php" style="color: red; cursor: unset;">YOUR PROBLEM</a></li>
