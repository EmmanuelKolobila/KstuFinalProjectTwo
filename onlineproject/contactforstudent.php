  ...
  <!-- ======= Contact Section ======= -->
    <section id="contact" class="section-bg">
      <div class="container" >
        ...
        <div class="form pb-3 px-3" id="formcontainer">
          <form action="" method="post">
            <div id="put" class="text-center pt-3">
              PLEASE KINDLY FILL THIS FORM FOR US IT HELPS US TO IMPROVE OUR SYSTEM
            </div>
            <div class="text-center mb-3"><b style="color: #ca5757;">NOTE:</b>THIS FROM IS FOR STUDENT <b style="color: #ca5757;">ONLY</b></div>
            <div class="row">
            ...
            <div class="row mb-3">
              <div class="form-group col-md-6">
                <input type="text" name="phone" class="form-control" id="index" placeholder="Phone Number" required>
              </div>
              <div class="form-group col-md-6">
                <input type="text" class="form-control" name="level" id="level" placeholder="Your Level Optional" required>
              </div>
            </div>
            ...
            <div class="form-group mb-3">
              <input type="text" class="form-control" name="dep" id="subject" placeholder="Student/Stuff" required>
            </div>
            <div class="form-group">
              <textarea class="form-control" name="message" rows="5" placeholder="What improvement do you want us to add to the system?" required></textarea>
            </div>
            <div class="my-3">
            ...
            <div onclick="window.alert('Form submited')" class="text-center"><button type="submit" id="button" class="py-3 px-5" name="save">Send Message</button></div>
          </form>
        </div>
