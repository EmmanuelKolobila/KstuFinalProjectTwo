        ...
        <nav class="navbar navbar-expand-lg custom_nav-container">
          <a class="navbar-brand" href="index.php">
            ...
            <span>
              ...
              <!-- <div id="spl" style="display: none">student Problems logs</div> -->
            </span>
          </a>
          ...
          <!-- <div class="carousel-inner" id="comeup" > -->
            ...
            <div class="container" style="align-items: center">
              <div class="com" style="color: black; text-align: center; margin-top: 4%"><h1 style="color: black" id="make"><b>WELCOME TO KsTU I.C.T DIRECTORATE STUDENT HELP DESK</b></h1>
                <div class="com" ><h1id="make"><b>STUDENT ANNOUNCEMENT PAGE</b></h1>
                <p ><h2 style="color: #ffff" id="makee"> portal </h2><br> <b><i>please try to contact us anytime you have i.c.t problem</b> </i></p></div>
