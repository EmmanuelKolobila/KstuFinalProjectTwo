...
$complainno=$cmpn;
echo '<script> alert("Your problem has been successfully filled and your problem no is  "+"'.$complainno.'")</script>';
}
?>
     ...
     <?php include("includes/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> ENTER YOUR PROBLEM AND SUBMIT</h3>
...
<label class="col-sm-2 col-sm-2 control-label">Nature Of Problem</label>
<div class="col-sm-4">
...
<select name="complaintype" class="form-control" required="">
                ...
                <option value="yes"> YES</option>
                  ...
                  <option value="an_new">AM NEW</option>
                </select> 
</div>
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Problem Details </label>
<div class="col-sm-6">
...
<div class="col-sm-6">
  Optioanl: TAKE A PICTURE OR A SCREENSHOT OF YOUR BROBLEM AND LOAD IT 
