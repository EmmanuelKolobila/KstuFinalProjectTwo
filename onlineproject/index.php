  ...
  <main id="main">
    ...
    <section id="featured-services">
      <div class="container">
        <div class="row">
          <a href="vclass.php">
            <div class="col-lg-4 box" id="option">
            ...
            <div class="col-lg-4 box box" id="option">
              <a href=""></a>
          ...
          <div class="col-lg-4 box" id="option">
            <a href="vclass.php"><i class="bi bi-list"></i></a>
            <h4 class="title"><a href="../onlineproject/userinterface.php">MORE OPTIONS</a></h4>
            <a href="vclass.php">
    ...
    <section id="about">
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header">
          <h3>About K<b class="text-lowercase">s</b>TU Help Desk</h3>
          <p>The ICT Directorate at Kumasi Technical University (KsTU) plays a crucial role in managing and overseeing all technology-related operations within the institution. This dedicated team ensures that the university’s infrastructure, systems, and services run smoothly to support both academic and administrative functions</p>
        </header>
        ...
        <div class="row about-cols">
          ...
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
            <div class="about-col">
              ...
              <p>
              To align with the KsTU mission to facilitate & support a World-Class University focused research, teaching and learning in Engineering, Science, Technology and Entrepreneurship Training with reliable IT Solutions.
              </p>
            </div>
          </div>
          ...
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
            <div class="about-col">
              ...
              <p>
              Proactive means and solutions r User First approach solutions
Clear and Simple Communication
Stay secure (cyber security)
Evolving staff knowledge base professional training and development for society
              </p>
            </div>
          </div>
          ...
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
            <div class="about-col">
              ...
              To take
"User-Satisfaction",
proactive approach to deliver excellent IT
Services, While
staying agile to drive digital innovations and Cyber Security.
              </p>
            </div>
          </div>
    ...
    <section id="services">
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header wow fadeInUp">
          <h3>k<b class="text-lowercase">s</b>tu help desk Services</h3>
          <p>ACCESS STUDENT IN THIER VARIOUS QUERIES SUCH AS:</p>
        </header>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 box" data-aos="fade-up" data-aos-delay="100">
            ...
            <h4 class="title"><a href="wifi.php">Wifi Connection</a></h4>
            <p class="description">Kindly follow the procedure to connect the school wifi</p>
          </div>
          <div class="col-lg-4 col-md-6 box" data-aos="fade-up" data-aos-delay="200">
            <div class="icon"><i class="bi bi-book"></i></div>
            <h4 class="title"><a href="../onlineproject/vclass.php">Vclass Access</a></h4>
            <p class="description">Kindly follow the procedure to access KsTU Vclass</p>
          </div>
          ...
          <div class="col-lg-4 col-md-6 box" data-aos="fade-up" data-aos-delay="200">
            <div class="icon"><i class="bi bi-wifi"></i></div>
            <h4 class="title"><a class="nav-link scrollto"href="wifi.php">Wifi Reset</a></h4>
            <p class="description">Kindly follow the procedure to reset your wifi passward</p>
          </div>
          <div class="col-lg-4 col-md-6 box" data-aos="fade-up" data-aos-delay="300">
    ...
    <section id="call-to-action">
      <div class="container text-center" data-aos="zoom-in">
        ...
        <p> KsTU I.C.T Directorate Student problems logs  </p>
        <a class="cta-btn" href="../partof/index.php">Call To Action</a>
      </div>
  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bi bi-chevron-right"></i> <a href="workers.php">Terms of service</a></li>
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              MP-Block Basement <br>
              <strong>Phone:</strong> 054 032 3877<br>
              <strong>Email:</strong> info@KsTU.com<br>
            </p>
          ...
          <div class="col-lg-3 col-md-6 footer-newsletter">
            ...
            <form action="" method="post">
              ...
              <select type="text" name=></select> <input type="submit" value="Subscribe">
            </form>
          </div>
    ...
    <!-- <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>EMMNAUEL</strong>. All Rights Reserved
      </div>
      <div class="credits">
        ...
        Designed by <a href="https://bootstrapmade.com/">KOLO de RIGHTOUES</a>
      </div>
    </div> -->
  </footer><!-- End Footer -->
