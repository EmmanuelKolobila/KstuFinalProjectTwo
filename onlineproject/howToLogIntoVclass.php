...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/about.css">
  <link rel="stylesheet" type="text/css" href="css/vclassVedio.css">
...
<body>
	...
	<div id="abouthead" style="margin-top: 60px" class="container-fliud p-3">
	...
	<div id="directhome" class="container-fliud p-5 text-center">
		<div id="_home" class="pt-2">How To Log InTo Vclass</div>
		<div id="_about" class="pb-3">VIDEO REPRESENTATION ON HOW TO LOG INTO VCLASS</div>
